...
const defineAnimation = (builder) => {
    builder
        ...
        .step((step) => {
            step.moveTo(block1.value, 200, 150, {
                duration: 800,
                easing: "easeOut",
            }).moveTo(block2.value, 300, 150, {
                duration: 1000,
                easing: "backOut",
                delay: 200,
            });
        ...
        .step((step) => {
            step.scaleTo(block1.value, 1.2, {
                duration: 600,
                easing: "bounceOut",
            })
                .resizeTo(block2.value, 180, 120, {
                    duration: 700,
                    easing: "elasticOut",
                })
                .show(block3.value, {
        ...
        .step((step) => {
            step.moveTo(block1.value, 150, 200, {
                duration: 1000,
                easing: "elasticOut",
            })
                .moveTo(block2.value, 350, 200, {
                    duration: 1000,
                    easing: "elasticOut",
                    delay: 100,
                })
                .moveTo(block3.value, 250, 100, {
                    duration: 800,
                    easing: "backOut",
                    delay: 200,
                });
        ...
        // Step 4: Cool finale
        .step((step) => {
            step.scaleTo(block1.value, 0.8, {
                duration: 400,
                easing: "bounceOut",
            })
                .scaleTo(block2.value, 0.8, {
                    duration: 400,
                    easing: "bounceOut",
                    delay: 100,
                })
                .scaleTo(block3.value, 1.3, {
                    duration: 600,
                    easing: "elasticOut",
                    delay: 200,
                });
